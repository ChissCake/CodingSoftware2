...
public abstract class StackTest {
    ...
    @Test
    public final void testPushNonEmptyRepeating() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("green", "red", "blue");
        Stack<String> sExpected = this.createFromArgsRef("green", "green",
                "red", "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void testPopLeavingNonEmpty() {
        /*
         * Set up variables
         */
