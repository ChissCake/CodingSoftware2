 ...
 * [$this.postFinish points to the last dummy node]  and
...
public class List2a<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        //Add a node that points to leftfront.next as next and left front as previous
        // update leftfront.next and leftfront.next to point to the new node
        Node p = new Node();
